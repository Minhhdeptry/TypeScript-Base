      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            {errors.teacher && <span className='text-red-500'>{errors.teacher.message as string}</span>}
        </div>
        ...
        <div>
          ...
          {errors.category && <span className="text-red-500">{errors.category.message as string}</span>}
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          {errors.credit && <span className="text-red-500">{errors.credit.message as string}</span>}
        </div>
